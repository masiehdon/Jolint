  ...
  return (
    <div className={styles.imageSlider}>
      {images.map((image, index) => (
        <div key={index} className={styles.imageWithCaption}>
          <img
            src={image.src}
            alt={`Image ${index + 1}`}
  ...
  return (
    <div className={styles.body}>
      ...
      <p className={styles.paragraph}>
        ...
        By fostering an inclusive environment, several positive outcomes can be achieved,
        including happiness, creativity, and success. Let's explore each of these aspects.
      </p>
      <h1 className={styles.customHeading1}>About inclusion at workplace</h1> <ImageSlider images={images1} />
      <h2 className={styles.customHeading2}>About diversity in organizations</h2> <ImageSlider images={images2} />
      <h3 className={styles.customHeading3}>About mental health at work</h3> <ImageSlider images={images3} />
    </div>
  );
};
